...
<body>
    ...
    <!-- <div class="alert alert-success">
        <?= $msg ?>
        <a href="./admin/logout.php" class="btn btn-primary">logout here</a>
    </div> -->
        ...
        <div class="row">
            <div class="col-lg-7 px-0">
                <div class="owl-carousel main-carousel position-relative">
                    ...
                    <img class='img-fluid w-100' src='Nimg/download.jpeg' style='object-fit: cover;'>
                             ...
                             <?php
                              $data = $conn->query("SELECT * FROM news")->fetchAll();
                                ...
                                foreach ($data as $news){
                                  $newsname= $news['news_date,title,content,author,category,photo'];
                                  echo "<div data-filter='{$newsname}'>{$newsname}</div>";
                                ...
                                foreach($data as $k) {
                                    ...
                                    echo "
                                           ...
                                           <img class='img-fluid w-100' src='Nimg/{$k['photo_name']}' alt='Description of the image' loading='lazy' style='object-fit: cover;'>
                                            <img class='img-fluid w-100' src='Nimg/download.jpeg' style='object-fit: cover;'>

                                            <a class='text-body' href=''>{$k['news_date']}</a>
                                            <h1 >{$k['title']}</h1>
                                            <p> {$k['content']}</p> 
                                            <span>{$k['author']}</span>
                ...
                <div class="col-lg-4">   -->
                    ...
                    <div class="mb-3">
                        ...
                        <div class="bg-white border border-top-0 p-3">
                            ...
                            //       echo "<a href='./single.php?id={$k['category_id']}' class='btn btn-sm btn-outline-secondary m-1' data-filter='{$catname}'>{$catname}</a>";
                            ...
                            //     }
                                    ...
                                    foreach ($data as $category) {
                                        ...
                                        echo "<a href='./single.php?id={$catid}' class='btn btn-sm btn-outline-secondary m-1' data-filter='{$catname}'>{$catname}</a>";
                                    }
            ...
            <div class="col-lg-3 col-md-6 mb-5">
                ...
                <div class="m-n1">
                              <?php
                                foreach ($data as $category){
                                  $catname= $category['category_name'];
                                  echo "<a href='./single.php?id={$category['category_id']}' class='btn btn-sm btn-outline-secondary m-1' data-filter='{$catname}'>{$catname}</a>";
