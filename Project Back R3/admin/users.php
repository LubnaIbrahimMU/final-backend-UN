                      ...
                      <li><a class="collapse-link"><i class="fa fa-chevron-up"></i></a>
                              ...
                              <?php
                                foreach ($data as $users){
                                  $usrname= $users['full_name,user_name,email,photo_name'];
                                  echo "<li data-filter='{$usrname}'>{$usrname}</li>";
                  ...
                  <div class="x_content">
                    ...
                    <table id="datatable" class="table table-striped table-bordered" style="width:100%">
                      ...
                      <tbody>
                              ...
                              <?php
                                foreach($data as $k) {
                                    ...
                                    <tr>
                                            ...
                                            <td>
                                            <a href='./del_user.php?id={$k['user_id']}'><img src='./images/delete.png' alt='Delete'></a>
                                            </td>
                                    </tr>";
                                }
                        ...
                        <!-- <tr>
                      // <td>
                      // <a href='./del_user.php?id={$k['category_id']}'><img src='./images/delete.png' alt='Delete'></a>
                      // </td>
                          <td>1 Jan 2023</td>
                          <td>Tony Adam</td>
                          <td>tony2023</td>
