                      ...
                      <li><a class="collapse-link"><i class="fa fa-chevron-up"></i></a>
                              ...
                              <?php
                                foreach ($data as $category){
                                  ...
                                  echo "<li data-filter='{$catname}'>{$catname}</li>";
                              ...
                              <?php
                                ...
                                foreach($data as $k) {
                                    ...
                                    <tr>
                                            ...
                                            <td>
                                            <a href='./editCategory.php?id={$k['category_id']}' data-filter='{$catname}' ><img src='./images/edit.png' alt='Edit'></a>

                                            </td>
                                            <td>
                                            <a href='./del_cat.php?id={$k['category_id']}'><img src='./images/delete.png' alt='Delete'></a>
                                            </td>
                                    </tr>";
                                }
                                ...
                                ?>
                        <!-- <tr>
                              <a href='./up_cat.php?id={$k['category_id']}'><img src='./images/edit.png' alt='Edit'></a>
