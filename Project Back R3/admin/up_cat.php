...
//   $email = $_POST['email'];
//   $date = $_POST['date'];
//   $num = $_POST['num_of_per'];
//   echo $name;

//   if (!empty($name) &&  !empty($phone) && !empty($email) && !empty($date) && !empty($num)) {
//     $sql="UPDATE users
//   SET user_name='$name', phone_number='$phone', email='$email', 
//   number_of_persons='$num', book_date='$date'
//   WHERE user_id='$id'";
									...
									<form id="demo-form2" data-parsley-validate class="form-horizontal form-label-left" action="<?= $_SERVER['PHP_SELF']?>" method="post" >
										...
										<div class="item form-group">
											...
											<div class="col-md-6 col-sm-6 ">
												<input type="text" id="add-category" required="required" class="form-control " name="cat">
											</div>
										</div>
